...
void VulkanUtil::createBuffer(VulkanContext &context, VkDeviceSize size,
...
void VulkanUtil::copyBuffer(VulkanContext &context, VkCommandPool commandPool,
...
void VulkanUtil::createImage(VulkanContext &context, uint32_t width,
  ...
  if (vkAllocateMemory(context.device, &allocInfo, nullptr, &imageMemory) !=
      VK_SUCCESS) {
...
VkImageView VulkanUtil::createImageView(VulkanContext &context, VkImage image,
                                        VkFormat format,
...
void VulkanUtil::endSingleTimeCommands(VulkanContext &context,
                                       VkCommandPool commandPool,
                                       VkCommandBuffer commandBuffer) {
